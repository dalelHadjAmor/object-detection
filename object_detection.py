...
classes = ["background", "person", "bicycle", "car", "motorcycle",
  ...
  "book", "clock", "vase", "scissors", "teddy bear", "hair drier", "toothbrush" , "book"]
...
while True:
  ...
  for detection in cvOut[0,0,:,:]:
    ...
    if score > 0.3:
      ...
      if classes[idx] == 'fork' or classes[idx] == 'suitcase' or classes[idx] == 'bottle'or classes[idx] == 'cell phone' or classes[idx] == 'person' or classes[idx] == 'book':          
